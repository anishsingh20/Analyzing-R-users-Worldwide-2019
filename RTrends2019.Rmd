...
hchart(EdlevelIndia,hcaes(x=EdLevel,y=count,type="column",name="Count")) %>%  
  hc_exporting(enabled = TRUE) %>%
  hc_title(text="Barplot of Education level of Indian respondents",align="center") %>%
  hc_add_theme(hc_theme_elementary()) 
...
Let'd check the results for Germany.
