...
Let's see for the US,Japan and Chinese respondents
...
hchart(JfUS,hcaes(x=TOPJF$JobFactors,y=TOPJF$Count),type="column",color="#FDE725") %>%  
  hc_exporting(enabled = TRUE) %>%
  hc_title(text="Job Factors which matter the most",align="center") %>%
  hc_add_theme(hc_theme_elementary()) 
...
hchart(JfChina,hcaes(x=TOPJF$JobFactors,y=TOPJF$Count),type="column",color="#FDE725") %>%  
  hc_exporting(enabled = TRUE) %>%
  hc_title(text="Job Factors which matter the most",align="center") %>%
  hc_add_theme(hc_theme_elementary()) 
...
hchart(JfJapan,hcaes(x=TOPJF$JobFactors,y=TOPJF$Count),type="column",color="#FDE725") %>%  
  hc_exporting(enabled = TRUE) %>%
  hc_title(text="Job Factors which matter the most",align="center") %>%
  hc_add_theme(hc_theme_elementary()) 
