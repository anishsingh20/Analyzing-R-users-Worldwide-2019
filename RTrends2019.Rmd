...
DrillDown <- function(data,filt,sel,gp) {
  
  df <- data %>% filter(Country=="India") %>% 
  select(JobSat) %>% 
  group_by(JobSat) %>% 
  summarise(Count=n()) %>% 
  arrange(desc(Count))
...
JobSatIndia <- DrillDown(data,)


JobSatIndia <- data %>% filter(Country=="India") %>% 
  select(JobSat) %>% 
  group_by(JobSat) %>% 
  summarise(Count=n()) %>% 
  arrange(desc(Count))
...
JobSatUS <- data %>% filter(Country=="United States") %>% 
  select(JobSat) %>% 
  group_by(JobSat) %>% 
  summarise(Count=n()) %>% 
  arrange(desc(Count))
...
JobSatGer <- data %>% filter(Country=="Germany") %>% 
  select(JobSat) %>% 
  group_by(JobSat) %>% 
  summarise(Count=n()) %>% 
  arrange(desc(Count))
